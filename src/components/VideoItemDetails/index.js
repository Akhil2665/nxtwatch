  ...
  <div className="video-item-details-container">
    ...
    <div className="video-full-details-container">
      ...
      <p className="about-channel">
        If your build system supports import statements, use react-player/lazy
        to lazy load the appropriate player for the url you pass in. This adds
        several reactPlayer chunks to your output, but reduces your main bundle
        size.
      </p>
    </div>
  </div>
